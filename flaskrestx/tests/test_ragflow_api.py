...
from ragflow_flaskrestx_wrapper import app, api
from unittest.mock import patch, MagicMock

from io import BytesIO


BEARER_TOKEN="ragflow-NhNTQyNDE0M2Y1ZTExZWZhZjBiMDI0Mm"
@pytest.fixture
def client():
...
def test_completion(client):
    with patch('requests.post') as mock_post:
        ...
        mock_post.assert_called_once_with(
            ...
            headers={"Authorization": "ragflow-NhNTQyNDE0M2Y1ZTExZWZhZjBiMDI0Mm"},
            json=data
        )
